...
export const OptionsBar: React.FC<OptionsBarProps> = ({
  ...
  return (
    <div className="bg-slate-900/95 border-b border-slate-800 p-4 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
          ...
          <div className="md:col-span-4">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-lg px-3 py-2 text-sm text-cyan-300 font-mono focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all placeholder:text-slate-600"
            />
          </div>
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-start px-3 py-2 rounded-lg border text-left transition-all ${
                      isActive
                        ? 'bg-cyan-950/40 border-cyan-500/80 text-cyan-200 ring-1 ring-cyan-500/50 shadow-sm'
        ...
        <div className="pt-2 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4 text-xs">
          ...
          <div className="flex items-center gap-2">
            <span className="text-slate-400 font-medium">Null Safety:</span>
